...
- **What to show:** The moment where the value is most obvious
- **Backup plan:** Screenshots/recording if live demo fails (always have this)
- **Timing:** Demo should take 4-6 minutes max
- **Narrate:** Say what you're doing and why as you do it

For Copilot Studio/D365 demos: pre-configure the environment, use realistic but sanitized data, test the demo path 3x before the talk.
...
Questions you don't know: "That's a great question. I don't have data on that — I'd be happy to follow up after. Can you grab me after the talk or connect on LinkedIn?"
